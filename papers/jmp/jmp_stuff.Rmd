...
reg1 <- lm(has_fac ~ electrification + urban_share + density_1564 + yrschool + factor(year), data_fac_loc_standardized)

reg2 <- lm(has_fac ~ electrification + urban_share + yrschool + factor(year), data_fac_loc_standardized)


# Stargazer output
stargazer(reg1, reg2, type = "latex", digits = 2, 
          covariate.labels = c("Electrification Rate", "Urbanization Rate", "Density (Age 15-64)", "Yrs. of Schooling"),
          dep.var.labels = c("Has Factory by 2006"), 
          title = "LPM Estimating Whether a Sub-district Has Factory by 2006", 
