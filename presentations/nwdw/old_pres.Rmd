...
p1 <- ggdraw() + draw_image("figures//map_facs.png")
p2 <- ggdraw() + draw_image("figures//region_assignment_chit.png")

p3 <- ggdraw() + draw_image("figures//regions_chit.png")
p4 <- ggdraw() + draw_image("figures//regions_bd.png")

plot_grid(p1, p2, p3, p4, nrow = 2,
          scale = c(1.2, .8, .8, 1.2),
          align = "hv", axis = "l",
          labels = c('Panel A. Factory Locations', 
                     'Panel B. Grouping Factories', 
                     'Panel C. Creation of Borders', 
                     'Panel D. Final Regions'), 
          label_size = 8, vjust = 1)
```